...
CHARA_NAME = {
    ...
    1004: ['阿尔托莉雅·潘德拉贡〔Lily〕','莉莉','白SABER','saberlily'],
    1005: ['尼禄·克劳狄乌斯','唔呣','罗马之花','红SABER','尼禄'],
    ...
    1038: ['库·丘林(caster)','术狗','c汪','c狗','c阶库丘林'],
    ...
    1076: ['莫德雷德','小莫','坑爹剑'],
    1077: ['尼古拉·特斯拉','特总','特斯拉'],
    1078: ['阿尔托莉雅·潘德拉贡〔Alter〕','枪黑呆','乳下','南半球'],
    ...
    1107: ['安哥拉曼纽','小安'],
    1108: ['伊斯坎达尔','大帝'],
    1109: ['卫宫〔Assassin〕','切丝PAPA','卫宫切嗣','切嗣','切丝'],
    1110: ['百貌哈桑','体操团','百貌'],
    1111: ['爱丽丝菲尔〔天之衣〕','太太','天之衣'],
    1112: ['酒吞童子','凹酱','酒吞'],
    1113: ['玄奘三藏','唐僧','唐三藏','唐玄奘','三藏'],
    1114: ['源赖光','奶光','赖光','奶子光'],
    1115: ['坂田金时(rider)','R狗蛋','r金时'],
    1116: ['茨木童子','脚神','茨木'],
    1117: ['风魔小太郎','五代风魔','小太郎','风魔'],
    1118: ['奥斯曼狄斯','拉二','拉美西斯二世'],
    1119: ['阿尔托莉雅·潘德拉贡(lancer)','狮子王','乳上','白枪呆','枪呆','北半球'],
    1120: ['尼托克丽丝','女法老','尼托'],
    ...
    1161: ['土方岁三','副长','土方'],
    1162: ['茶茶','淀殿'],
    1163: ['melt lilith','莉莉丝','刀锋战士','lls'],
    1164: ['Passionlip','lip'],
    1165: ['铃鹿御前','JK狐','铃鹿'],
    1166: ['BB','2B'],
    1167: ['杀生院祈荒','尼姑','杀生院','ssy'],
    1168: ['BeastⅢ／R','魔性菩萨'],
    1169: ['山鲁佐德','1001'],
    1170: ['武则天','媚娘','武媚娘'],
    1171: ['彭忒西勒亚','CEO','彭忒'],
    ...
    1196: ['埃蕾什基伽勒','艾蕾','枪凛'],
    1197: ['阿蒂拉·圣诞','弓大王','弓提拉','圣诞阿提拉','圣诞大王'],
    1198: ['葛饰北斋','阿荣','北宅'],
    1199: ['塞弥拉弥斯','女帝'],
    1200: ['浅上藤乃','拆桥','藤乃'],
    1201: ['阿纳斯塔西娅','皇女'],
    1202: ['阿塔兰忒〔Alter〕','黑塔','黑阿塔','狂塔','狂阿塔','猪皮塔'],
    1203: ['阿维斯布隆','哲学家'],
    1204: ['安东尼奥·萨列里','萨老师','安东尼奥','萨列里'],
    1205: ['伊凡雷帝','雷弟','雷帝'],
    1206: ['阿喀琉斯','脚后跟','阿脚','铁华团团长','jio后跟'],
    1207: ['喀戎','老师','马老师'],
    1208: ['齐格','齐傲天'],
    ...
    1219: ['贞德〔Alter〕(水着)','狂贞','泳装黑贞','水黑贞'],
    1220: ['BB(水着)','泳装bb'],
    1221: ['女王梅芙(水着)','泳装梅芙','水梅芙','剑梅芙'],
    1222: ['谜之女主角XX','XX毛','XX'],
    ...
    1234: ['红阎魔','小麻雀'],
    1235: ['李书文(assasin)','老李','杀阶李书文','杀阶李大师'],
    ...
    1245: ['拉克什米·芭伊','印度贞德'],
    1246: ['威廉·退尔','大叔'],
    1247: ['阿周那〔Alter〕','狂那','芭娜娜','狂娜'],
    1248: ['马嘶','轮子哥'],
    1249: ['阿斯克勒庇俄斯','医神'],
    1250: ['魔王信长','魔信','仇信'],
    1251: ['森长可','鬼武藏'],
    1252: ['长尾景虎','上杉谦信'],
    1253: ['莱昂纳多·达·芬奇(lily)','小碧池','达芬骑','达芬奇lily'],
    1254: ['伊阿宋','渣宋'],
    1255: ['帕里斯','白莲花'],
    1256: ['加雷斯','加妹'],
    ...
    1285: ['杀生院祈荒(水着)','水杀生院','人鱼','泳装杀生院','人鱼杀生院','蚌精'],
    1286: ['伊莉雅丝菲尔·冯·爱因兹贝伦(水着)','泳装伊莉雅','泳装伊利亚'],
    1287: ['布伦希尔德(水着)','泳装布姐'],
    1288: ['虞美人(水着)','水鱼','泳装虞姬','水虞姬'],
    1289: ['阿比盖尔·威廉姆斯〔夏〕','泳装阿比','水阿比'],
    1290: ['巴御前(水着)','泳装巴御前','水鲅鱼圈'],
    ...
    1301: ['迦尔纳(圣诞)','圣诞迦尔纳'],
    1302: ['千子村正','村正'],
    1303: ['平景清','黑牛丸','黑化牛若丸','仇牛丸'],
    1304: ['鬼一法眼'],
    1305: ['阿莫尔〔卡莲〕','卡莲'],
    1306: ['伽拉忒亚','ガラテア','加拉泰雅','手办'],
