...
try:
    ...
    unknown_chara_icon = R.img(f'fgo_unit/icon_unit_{UNKNOWN}31.png').open()
...
def download_chara_icon(id_, star):
    ...
    save_path = R.img(f'fgo_unit/icon_unit_{id_}{star}1.png').path
...
class Chara:
    ...
    def icon(self):
        ...
        res = R.img(f'fgo_unit/icon_unit_{self.id}{star}1.png')
        if not res.exist:
            res = R.img(f'fgo_unit/icon_unit_{self.id}31.png')
        if not res.exist:
            res = R.img(f'fgo_unit/icon_unit_{self.id}11.png')
        ...
        if not res.exist:
            res = R.img(f'fgo_unit/icon_unit_{self.id}11.png')
        if not res.exist:
            res = R.img(f'fgo_unit/icon_unit_{UNKNOWN}31.png')
        return res
